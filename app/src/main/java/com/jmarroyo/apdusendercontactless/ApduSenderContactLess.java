...
public class ApduSenderContactLess extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        mSendAPDUButton.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if( mFirstDetected==true && myTag.isConnected())
                {
                    ...
                    clearlog();
                    if(!bSendAPDU()) //primer llamaso para HACER LOGIN
                    {
                        vShowErrorVaules();
                    }
                    else{
                        //Segundo llamado para abrir la app
                        editCLA.setText("00");
                        editINS.setText("CB");
                        editP1.setText("3F");
                        editP2.setText("FF");
                        editLc.setText("0E");
                        editLe.setText("00");
                        editDataIn.setText("4D 0C 70 0A BF 82 11 06 7F 50 03 7F 60 80".replace(" ",""));
                        if(!bSendAPDU())
                        {
                            vShowErrorVaules();
                        }
                        else {
                            editCLA.setText("00");//tercera llamada pagina 17
                            editINS.setText("21");
                            editP1.setText("00");
                            editP2.setText("91");
                            editLc.setText("89");
                            ...
                            editDataIn.setText("7F 2E 86 81 84 79 0D 58 4C 17 5D 7D 1F 78 6D 21 5A 92 22 98 4D 28 9E 91 2B 98 8C 33 58 6E 39 9A 41 43 64 27 44 48 8D 4B 58 60 50 9E 7A 51 78 5D 5D 7B 30 5D 68 86 5E 98 48 60 42 8A 65 78 91 69 98 76 6B B8 45 6C 65 60 76 76 7B 78 76 89 7B 76 44 7C 6A 54 87 AD 8B 8B 74 60 8C AF 98 8C 78 59 8D AC 7B 8E B1 42 93 8D 6E 96 50 44 99 88 7A 9A AF 53 9B 8A 3C 9C 4B 8F A1 B3 89 A1 B1 94 A3 74 53 A7 66 8F B0 6F 6B C6 88".replace(" ",""));
                            if(!bSendAPDU())
                            {
                                vShowErrorVaules();
                            }
                ...
                else
                {
                    ...
                    editLc.setText("10");
                    editLe.setText("");
                    //editDataIn.setText("E828BD080FD25043686C43432D654944");
                    editDataIn.setText("E828BD080FD25043686C43432D654944");
        ...
        editP1.setText("04");
        editP2.setText("0C");
        editLc.setText("10"); //pagina 13 del doc.
